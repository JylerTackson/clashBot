...
source_url: "https://clashroyale.fandom.com/wiki/Heal_Spirit"
image_path: cards/images/heal-spirit.png
...
> *In-game description:* "A mischevious Spirit that leaps at enemies, dealing Damage and leaving behind a powerful healing effect that restores Hitpoints to friendly Troops!"

## Overview

The Heal Spirit is a Rare card that is unlocked from the Rascal's Hideout (Arena 13). It spawns a very fast, area-damage, air-targeting, short-ranged, ground troop with low hitpoints and low damage. It launches itself at its target when attacking, destroying itself on impact. It creates a small glowing restoration field that heals allied troops nearby. Its physical appearance is similar to an Ice Spirit, but it is lemon in color and is shaped more closely to a rectangle. It also has a red tongue which appears to be sticking out and a single yellow tooth.  A Heal Spirit card costs 1 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
This little guy runs, jumps, and splashes just like his Spirit siblings, all for the same 1 Elixir cost. The difference? When he jumps onto your opponent's troops or buildings, he'll deal damage to them while healing your troops that are around him. However, he isn’t the best at dealing damage among his siblings, even though he has the highest health.

## Attributes

**Heal Spirit Attributes**

| Cost | Speed | Deploy Time | Range | Splash Radius | Target | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|
...
|---|---|---|---|
| 4 pulses every 1 second | 0.25 sec | 2.5 | Air & Ground |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Area Damage | Healing Per Pulse | Healing Per Second |
|---|---|---|---|---|
| 3 | 100 | 51 | 47 | 188 |
| 4 | 110 | 56 | 51 | 204 |
| 5 | 121 | 62 | 57 | 228 |
