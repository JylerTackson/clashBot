...
source_url: "https://clashroyale.fandom.com/wiki/Tesla"
image_path: cards/images/tesla.png
scraped_at: "2026-09-02T02:33:02+00:00"
evolution_file: evolutions/tesla-evolution.md
arena: Hog Mountain
...
> *In-game description:* "Defensive building. Whenever it's not zapping the enemy, the power of Electrickery is best kept grounded."

**Related:** [Evolution: tesla-evolution](../evolutions/tesla-evolution.md)

## Overview

The Tesla is a Common card that is unlocked from the Hog Mountain (Arena 10). It spawns a single-target, air-targeting, medium-ranged, building with high hitpoints and high damage. When there are no enemies within range, it retracts underground, making itself immune to all damage except for the Earthquake and the Freeze. It appears to be a wooden lattice structure with a metal coil, cone and sphere placed on top which is surrounded by team-colored supports, a wire coiled around one of its pillar, and a wooden trapdoor with team-colored hinges. A Tesla card costs 4 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
Peek-a-boo! For 4 Elixir, it has moderate health and damage, pulling everything to itself, so that it can zap enemies, although it won't stun like most electric-based cards do. When nobody is near it, the Tesla hides underground, preventing any and all damage sources, except for an Earthquake. Vines and Freeze will also affect it, making it stuck on either the hidden or the revealed state.

 For 2 cycles, if its **Evolution**  is active, the Tesla accumulates so much voltage that it taught itself the art of **Pulsating Voltage**, causing it to release all that it accumulated. When deployed, the Tesla will send a pulse of electricity to ground and air units, dealing low damage and stunning them for 0.5 seconds, making it good for dealing with any kind of pushes. Every time it reveals itself after hiding, another pulse is released, until it is destroyed.
...
|---|---|---|---|---|---|---|---|---|
| 4 | 1.1 sec | 0.5 sec | 1 sec | 25 sec | 5.5 | Air & Ground | Building | Common |
...
| 8 | 866 | 34.6 | 165 | 150 |
| 9 | 952 | 38.1 | 182 | 165 |
| 10 | 1047 | 41.9 | 200 | 181 |
| 11 | 1152 | 46.1 | 220 | 199 |
| 12 | 1267 | 50.7 | 242 | 219 |
| 13 | 1394 | 55.8 | 266 | 241 |
| 14 | 1533 | 61.3 | 293 | 266 |
| 15 | 1687 | 67.5 | 322 | 292 |
| 16 | 1855 | 74.2 | 354 | 321 |
...
This card has an evolution: see [tesla-evolution.md](../evolutions/tesla-evolution.md). Cycles to evolve: 2. Stat boosts: N/A.
