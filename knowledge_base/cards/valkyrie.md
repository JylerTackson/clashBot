...
targets: ground
has_evolution: true
has_hero_variant: true
source_url: "https://clashroyale.fandom.com/wiki/Valkyrie"
image_path: cards/images/valkyrie.png
scraped_at: "2026-09-02T02:34:51+00:00"
evolution_file: evolutions/valkyrie-evolution.md
hero_file: heroes/valkyrie-hero.md
arena: Bone Pit
release_date: 4 January 2016
---

# Valkyrie

> *In-game description:* "Tough melee fighter, deals area damage around her. Swarm or horde, no problem! She can take them all out with a few spins."

**Related:** [Evolution: valkyrie-evolution](../evolutions/valkyrie-evolution.md) · [Hero variant: valkyrie-hero](../heroes/valkyrie-hero.md)

## Overview

The Valkyrie is a Rare card that is unlocked from the Bone Pit (Arena 2). It spawns an area-damage, ground-targeting, melee, ground troop with high hitpoints and high damage. The Valkyrie attacks by spinning with her axe, damaging all the ground troops surrounding her in a 360° area of effect. She resembles a woman who bears orange hair and eyebrows, have blue eyes, wields a double-sided axe, wears a team-colored suit, wristbands and boots, and attacks with a powerful whirl of her axe. A Valkyrie card costs 4 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
A 4 Elixir powerhouse with high health. This tough mini-tank swings her axe 360º to take out swarms and support troops alike. Despite this, she can't reach air troops and her slow movement speed leaves her susceptible to ranged attacks.

For 2 Cycles, if her **Evolution** is active, she forges her weapon into one that has the **Whirlwind Axe** ability: every time she attacks, her axe spins summon a whirlwind, pulling both ground and air units alike, dealing an additional damage tick. You can't run, don't even hide!

Similarly, if her **Hero** is active, stay away and seek shelter, because for 3 Elixir, you can use her **Wild Whirlwind** ability, which speeds her up and causes her to repeatedly spin her axe once she finds a target, dealing damage over time and traveling between all nearby units! She can't be frozen and takes reduced damage during spinning, but she can still be defeated during her ability.

## Attributes

**Attributes**

| Cost | Hit Speed | First Hit Speed | Speed | Deploy Time | Range | Splash Radius | Target | Count | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 1.5 sec | 0.1 sec | Medium (60) | 1 sec | Melee: Medium (1.2) | 2 | Ground | x1 | Ground | Troop | Rare |
...
- Ranged low- and medium-hitpoint troops: Musketeer, Witch, Archers, Mother Witch, Ice Wizard, Little Prince, Princess, Goblinstein, Electro Wizard, Firecracker, Bomber, Zappies, Archer Queen, Magic Archer, Dart Goblin, Spear Goblins and Wizard — a few swings kill them if she is dropped right on top.
- Ground swarms — her 360° splash stops her being surrounded by most of them.
- Melee units in a 1-on-1: Monk, Dark Prince, Prince, Mini P.E.K.K.A, Boss Bandit and even Mega Knight, especially if placed so their charge does not activate.
- Royal Recruits and Guards when she is dropped directly on top of them (she struggles if they approach her instead).
- Graveyard — her 360° attack clears Skeletons fast and she survives every offensive spell in the game.
- Goblin Barrel — placed one tile up from the bottom-outer corner of the Crown Tower she catches two Goblins, or all three if placed slightly early thanks to her fast first attack.
- Skeleton Barrel — let it pop on the Tower, then drop her among the Skeletons to wipe them in one spin.
- Lone Sparky across the bridge — at equal Level she survives one blast and kills her with Tower help for a positive Elixir trade.
- X-Bow pushes — she tanks and clears the frail support cards around it.
- Almost all non-building-targeting troops, with Crown Tower assistance, thanks to her hitpoints-per-Elixir.

## Weak against

- All air troops — she cannot hit them at all; Bats or Minions fully counter her if placed early and she has no support.
- Cheap ranged chip placed at a distance — Spear Goblins, Guards, Dart Goblin, Archers and Skeletons stall her slow movement while the Crown Towers work.
- Inferno Tower (placed far away so she must walk) and Inferno Dragon (placed in front of her, untargetable) when she is unsupported.
- Mini-tanks that pull her to the center — Knight, Lumberjack, Royal Ghost, Battle Healer, Prince, Skeleton King, Golden Knight, Monk or Mini P.E.K.K.A negate most of her Tower damage.
- Building-targeting kiters — Ice Golem, Elixir Golem, Goblin Giant or Battle Ram placed on the fourth tile from the bridge, 1 tile into the other lane, drag her across (Tornado or Fisherman can undo this).
- Cannoneer tower troop — the best tower troop against her, taking only 4 hits before she dies.
- Long-range chip units, especially against a Valkyrie placed behind the King Tower: Magic Archer, Firecracker and Evolved Bomber hit her and the Crown Tower at once.
- Fisherman — can pull her and force her to activate your King Tower.
- A Knight-style tank blocking her while an X-Bow chips her down.

## Notes / synergies

- Role: a 4 Elixir mini-tank and defensive splash unit — high hitpoints, moderate 360° area damage, slow movement, no air targeting.
- Play her reactively: wait for support troops to cross the bridge, then drop her on top of the whole push to save her hitpoints for a counterattack.
- Against melee ground swarms, place her a short distance away rather than on top so she is not hit while deploying — but drop her inside larger pushes to clear them faster.
- Against ranged troops always place her directly on top to nullify their range advantage; on offense a Tornado near her drags ranged units in for her to kill.
- Units with long melee range can hit her without taking splash while she is busy with another target.
- Do not underestimate a lone Valkyrie — even alone she deals heavy Crown Tower damage for 4 Elixir.
- She can be used to bait the opponent's tank counter so a Giant or Golem has an easier time afterwards.
- Pair her with air-targeting support to cover her one hard weakness: Wizard, Musketeer, Electro Wizard, Witch, Executioner, Princess, Goblinstein, Flying Machine, Dart Goblin, Hunter, Little Prince, Firecracker, Archers, Skeleton Dragons, Inferno Dragon, Spear Goblins, Electro Dragon, Zappies, Archer Queen, Magic Archer, Mega Minion, Ice Wizard or Baby Dragon.
- Valkyrie + Mini P.E.K.K.A. covers each other's weaknesses: put her in front and the faster Mini P.E.K.K.A. behind so he pushes her toward the Tower — she clears swarms, he handles tanks. Very weak to air.
- The same push with a Prince is stronger (more hitpoints, charge speed, knockback immunity to break a Bowler) but costs more and has lower DPS without the charge.
- Valkyrie + Elite Barbarians hits harder still, but costs more and their larger sight range separates them from her.
- Valkyrie + Goblins is the cheap version — the Goblins push her and add damage, but die to area damage.
- With fast building-targeting cards (Hog Rider, Ram Rider, Battle Ram, Wall Breakers) she protects them from swarms while they push her forward; Ram Rider also covers air.
- Witch pairs well: both splash, the Witch covers air, and her Skeletons distract P.E.K.K.A, Giant Skeleton, Prince, Mini P.E.K.K.A., Boss Bandit and Mighty Miner.
- Freeze + Valkyrie is a strong defensive combo — freeze the ranged support behind a tank and let her splash wipe them out.
- Valkyrie in front of a Balloon soaks Crown Tower fire and clears the small units sent at it, but the combo dies to air troops and to a building + tank answer.
- Trifecta (Hog Rider + Musketeer + Valkyrie): she tanks for the Hog on offense and for the Musketeer on defense; place the Hog Rider behind her so she stays in front. It loses to Lightning, to Minion Horde (unless Zapped), hard to a P.E.K.K.A for +5 Elixir, to Rocket for up to +6 (Tornado then Rocket for +3), and to a Bowler's knockback.
- When she locks onto your Crown Tower, do not place ranged defenders too close to the Tower or her splash chips both at once.
- Against a Fisherman placed behind the King Tower, put her at the bridge — his hook will pull her in and let her damage the Crown Tower unexpectedly.

## Evolution

This card has an evolution: see [valkyrie-evolution.md](../evolutions/valkyrie-evolution.md). Cycles to evolve: 2. Stat boosts: N/A.

## Hero variant

This card has a Hero form (Wild Whirlwind, ability cost 3 Elixir): see [valkyrie-hero.md](../heroes/valkyrie-hero.md).
...
- clock 2:34 (t=19.2) and clock 1:35 (t=78.6): 4-elixir Heroic Valkyrie deploys at tiles [9, 12] and [4, 13], each immediately followed by a 3-elixir drop that is the Hero ability Wild Whirlwind (3 elixir, no hand change) — "I want to just go for a Valkyrie plus ability at the bridge here. Grab some of my damage back. Let's go for the ability here."
- clock 2:29-2:19 (t=25-37): his read on the Hero — "the hero Valkyrie is actually bugged so it is really actually nearly impossible to defend against that card. Every time your opponent pops the ability, they will be going right to your tower" — and the reason Freeze sits in the deck alongside her.
- clock 0:43-0:31 (t=130-140): the bridge-plus-Wild-Whirlwind pattern that takes the enemy left tower from 4627 to 2890 — "I'm going to Valkyrie the bridge here on the left. Then, I'm going to pop the ability, too, just to go up to the tower... There's nothing that they can do about it."
- clock OT 1:13 (t=220.2) and OT 0:51 (t=242.7): repeats the bridge deploy at tile [2, 15] plus ability to finish the game — "could I just Valkyrie the bridge here and pop the ability? Like, how does he stop it? It's just TOO BROKEN." The only answer he respects is a Tornado pull-back: "he has to just bring it back, which I like that play a lot... I'm going to have to steal that from this guy" (t=85-96).
...
- clock 2:26: his Heroic Valkyrie is the 4-elixir half of the two-card commit that punished a back-line Lava Hound and took the first tower to 916 HP — "I went for Valkyrie and E-Barbs together just to ensure that I end up taking the entire tower cuz if I just went for the E-Barbs, then he would have just been able to go for the ... like the Barbarians if he has them".
- clock 1:41 and clock 1:32: played her behind the Battle Ram at the right bridge, "a Valkyrie in the pocket", then re-aimed her as a blocker rather than a threat — "Actually, let's Valkyrie the bridge. Hold on, wait, we block for this? That's going to keep the Mother Witch alive a bit". She is the escort that keeps the Mother Witch and her Cursed Hogs alive on offence.
- clock 0:56: back with the evolved Battle Ram for the tower he had to have — "let's go for the Evo Ram plus Valkyrie cuz I need to make sure that I take this tower. Cuz if I don't take the tower, then I could lose". All four of her deploy labels this match ((14, 15) three times, (8, 19) once) were mis-attributed to the opponent by the pipeline.
- Hero note: this is the Heroic Valkyrie, whose Wild Whirlwind ability costs 3 elixir and empties no hand slot, so bare -3 elixir steps in this match (t=394.4, t=396.9) are more likely ability activations than card plays. He never calls the ability out loud.
...
- clock 2:41: Valkyrie (Hero) toward the bridge at tile [3, 12], with the Wild Whirlwind ability popped ~3 s later (a 3-elixir drop with no hand change) — "I'm just going to valkyrie the bridge and then go for the ability here cuz that's guaranteed to go up to the [Goblin Giant]. It's going to pretty much take out the whole thing if the valkyrie starts running back." It fizzled: "Oh, why did the valkyrie stop running?"
- clock 1:47: Valkyrie behind the tower trade as the ground answer to the surviving P.E.K.K.A. push, paired with Heal Spirit — "Okay, let's get a valkyrie down here and then we can go for a heal spirit as well."
- clock 0:47 and 0:17: placed "in front" of the tower as the ground blocker while the crown tower chipped — "Let's go for the valkyrie in front as well" and "Let's just go for the quick valkyrie here. We have the ability plus freeze ready."
- overtime 1:50: Valkyrie back at the bridge (label at [13, 20]) in the winning push — "we can just go for the Valkyrie here at the bridge. He's going to pop the ability, but batter him on the King Tower."
...
- His Heroic Valkyrie, the 8th slot of the deck. clock 0:53: deployed on his own half at tile [4, 8] (deploy label 'ValkYRie', score 1.0, elixir 10 -> 6) and walked up the left lane, crossing the river ten seconds later — he builds with her rather than dropping her at the bridge.
- OT 0:47: the 3-elixir Wild Whirlwind ability as a finisher — "then we can Valkyrie and hit the ability cuz it's going to go right up to the tower, guys. Ability here. Come on. Nice." The ability empties no hand slot, so it shows up only as 3-elixir drops with no hand change (nine of them: t=690.4, 714.0, 764.1, 768.3, 803.5, 889.4, 894.1, 898.1, 904.2).
- OT 1:10: he holds the ability when the value is gone — "Could pop the ability, but it's not worth it anymore" — and calls it again at OT 0:11: "Go for the Valkyrie here and we can pop the ability just to help take this all out."
- The opponent plays a Valkyrie too, and Ryley's Freeze is aimed squarely at it — "His Valkyrie is going to get to my tower. I have to freeze it" (OT 0:03). The video intro frames why: "the hero Valkyrie is actually bugged... Every time your opponent pops the ability, they will be going right to your tower. That is why we are playing freeze in this mother witch deck today."
...
- clock 1:23: he is on the Heroic Valkyrie (Hero variant of Valkyrie: 4 elixir, plus a 3-elixir 'Wild Whirlwind' ability that empties no hand slot). With her already on the field he pops the ability on an incoming Firecracker - "let's just pop the ability. It's going to kill the firecracker and go to the tower, which is super good" - but she dies at clock 1:19 ("There goes the Valkyrie, and Wait, what?") and the Firecracker survives.
- clock 1:16 to 1:07: he states the balance takeaway - "I guess firecracker is alive ... Okay, it's no longer killing firecrackers. That is good to know" - i.e. Wild Whirlwind no longer one-shots a Firecracker; he still counts the lane pull, "At least it's going to go to the other lane, though, so it's technically dead, I guess."
- clock 0:27: second Heroic Valkyrie deployed at the bridge, deploy label 'ValkYRie' at tile [13, 15], ability popped straight away - "Let's Valkyrie the bridge, too, and pop the ability. We need to kill that Firecracker. Yeah, beautiful Valkyrie." The enemy right tower reads 342 -> 188 over the next two seconds.
- Because the 3-elixir ability charge shows as an own elixir drop with no hand change, several of this game's UNIDENTIFIED -3 events (t=1011.8, t=1071.2) are most likely ability pops rather than card plays.
- post-game (t=1103s), and the reason the card is in the video: "Hero Valkyrie is just so strong and Mother Witch, too, dude."
...
- clock 1:22: calls his Heroic Valkyrie as the defensive answer to the opponent's Ice Golem push, paired with Mother Witch behind her — "Okay, he goes for the ice golem. Let's just go for the Valkyrie and mother witch here."
- clock 0:42: plays her offensively at tile [3, 19] on the enemy king tower (his own level-16 deploy label) and immediately spends 3 elixir on the Wild Whirlwind ability — "I'm just going to Valkyrie the king tower and hit the ability. There's no way that he can defend this." The spin carried her off the tower: "Oh my god, wait. It went back. That doesn't go right up to the tower, but it's not like super away from the tower either."
- clock 0:12: Valkyrie plus the ability used to strip an incoming push rather than as a bridge threat — "I need to make him waste his ram or something just go for the Valkyrie plus ability. Okay, let's go for the Valkyrie here."
- overtime 1:48: Valkyrie as the anti-three-crown block behind a Heal Spirit — "Heal Spirit here. Block this and we go for the Valkyrie here and we're not going to get three crowned by that so we're fine." (The HUD logs these as 3-elixir "Bandit" events, which matches the Wild Whirlwind ability cost rather than a card play.)
...
- This slot is the Heroic Valkyrie (hero variant of Valkyrie, with the 3-elixir "Wild Whirlwind" ability). Deploy labels at clock 2:38 (tile [3, 13]), 1:29 (tile [13, 15]) and overtime 1:53 (tile [9, 19]), each followed by a 3-elixir drop with no hand change - the ability, which the HUD reader cannot see and sometimes logs as another card.
- clock 2:38 (1351-1357s): bridge opener with the ability on top - "I just want to go for a Valkyrie at the bridge here on the right and let's pop the ability as well. Let's go right up to those Zappies and make sure that we get onto the tower"; he then admits "It probably wasn't [worth it] but if it works out then it'd be funny".
- clock 1:29-1:16 (1429-1436s): pushed behind a Battle Ram to kill the support - "we can hit our ability now and go right up to the tower kill the wizard"; the enemy right tower went 2716 -> 529 HP, saved only by the opponent's own Wizard hero ability.
