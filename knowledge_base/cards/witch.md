...
source_url: "https://clashroyale.fandom.com/wiki/Witch"
image_path: cards/images/witch.png
scraped_at: "2026-09-02T02:34:59+00:00"
evolution_file: evolutions/witch-evolution.md
...
> *In-game description:* "Summons Skeletons, shoots destructo beams, has glowing pink eyes that unfortunately don't shoot lasers."

**Related:** [Evolution: witch-evolution](../evolutions/witch-evolution.md)

## Overview

The Witch is an Epic card that is unlocked from the P.E.K.K.A's Playhouse (Arena 6). It spawns an area-damage, air-targeting, medium-ranged, ground troop with moderate hitpoints and moderate damage. Every 7 seconds, the Witch will passively summon a group of four Skeletons surrounding her. However, her first wave of Skeletons will spawn 1 second after she is deployed. She appears as a woman with glowing pink eyes, no legs, wears a violet cloak, a dark gray top, dark purple lipstick, two golden skulls on her shoulders, team-colored gloves with golden armlets, a golden belt with a skull face in the middle, and a team-colored dress, and wields a staff with a ram skull on top with two golden horns on its head. A Witch card costs 5 Elixir to deploy.
...
For 1 Cycle, if her **Evolution** is active, she learns a new power called **Boned-aid** (as in Band-aid!). When her initial Skeletons get defeated, their soul will be recycled and will heal the Witch's hitpoints. This healing can overheal and cause her to tank even a Lightning!

## Attributes

**Witch Attributes**

| Cost | Hit Speed | First Hit Speed | Speed | Deploy Time | Spawn Speed | Range | Splash Radius | Projectile Speed | Target | Count | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 5 | 1.1 sec | 0.7 sec | Medium (60) | 1 sec | 7 sec | 5.5 | 1.5 | 600 | Air & Ground | x1 | Ground | Troop | Epic |

**Skeleton Attributes**

| Hit Speed | First Hit Speed | Speed | Range | Target | Transport | Type |
|---|---|---|---|---|---|---|
| 1.1 sec | 0.5 sec | Fast (90) | Melee: Short (0.5) | Ground | Ground | Troop |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Area Damage | Damage per second | Skeleton Hitpoints | Skeleton Damage | Skeleton Damage per second |
|---|---|---|---|---|---|---|
| 6 | 521 | 84 | 76 | 50 | 50 | 45 |
| 7 | 573 | 92 | 83 | 55 | 55 | 49 |
| 8 | 630 | 101 | 91 | 61 | 61 | 55 |
| 9 | 693 | 112 | 101 | 67 | 67 | 60 |
| 10 | 763 | 123 | 111 | 74 | 74 | 67 |
| 11 | 839 | 135 | 122 | 81 | 81 | 73 |
| 12 | 923 | 149 | 135 | 89 | 89 | 80 |
| 13 | 1015 | 163 | 148 | 98 | 98 | 89 |
| 14 | 1117 | 180 | 163 | 108 | 108 | 98 |
| 15 | 1228 | 198 | 179 | 119 | 119 | 108 |
| 16 | 1351 | 217 | 197 | 130 | 130 | 118 |
...
#### Common: Speedy Spawn
> "+100% spawn speed"
Doubles witch unit spawn speed.
#### Rare: On Guard!
> "Spawn Guards"
Witch spawns Guards instead of normal Skeletons.
#### Epic: Skelebrate Good Times
> "Spawn Evo Skellies"
Witch spawns Evolved Skeletons instead of normal Skeletons.
