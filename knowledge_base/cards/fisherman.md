...
source_url: "https://clashroyale.fandom.com/wiki/Fisherman"
image_path: cards/images/fisherman.png
scraped_at: "2026-09-02T02:35:13+00:00"
arena: "Miner's Mine"
release_date: 5 August 2019
---

# Fisherman

> *In-game description:* "His Ranged Attack can pull enemies towards him, and pull himself to enemy buildings. He's also mastered the ancient art of 'Fish Slapping'."

## Overview

The Fisherman is a Legendary card that is unlocked from the Miner's Mine (Arena 15) or a Legendary Chest. It spawns a single-target, ground-targeting, melee, ground troop with moderate hitpoints and moderate damage. If there are ground units between 3.5 and 7 tiles of him, he will stop moving and begin charging a hook attack which takes 1.3 seconds to execute, and either pulls enemy troops towards him, or pulls himself towards buildings, and slow their movement and attack speed by 35% for 1.5 seconds. The Fisherman takes an appearance as a man with a large nose, blue eyes, blonde eyebrows and beard, wearing a team-colored hat which covers his eyes and overalls with a team-colored patch on it and a star shell behind it, and carries a hook tied on a rope and a deep indigo fish. A Fisherman card costs 3 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
Get over here! The Fisherman pulls troops towards him with his hook so he can kill them with a slap from his daily catch. Against buildings, he pulls himself towards them to save the time and energy of walking towards them. He's a bit weak to tanks and swarms, but all this hook, line, and fish slap for only 3 Elixir? Those statistics get me hooked!
...
|---|---|---|---|---|---|---|---|---|---|---|
| 3 | 1.3 sec | 0.1 sec | Medium (60) | 1 sec | Melee: Medium (1.2) | Ground | 1 | Ground | Troop | Legendary |

**Hook Attributes**

| Hook Time | Hook Range | Hook Projectile Speed | Target | Transport |
|---|---|---|---|---|
| 1.3 sec | 3.5-7 | 800 | Ground | Ground |
...
#### Common: Tough as Scales
> "+100% hitpoints"
Doubles Fisherman hitpoints.
#### Rare: Down to Earth
> "Hook air troops"
Can hook and pull air units.
#### Epic: Hook Me Baby One More Time
> "Infinite hook range"
Is able to hook to the nearest enemy or Crown Tower in the arena.
