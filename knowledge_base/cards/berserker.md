...
source_url: "https://clashroyale.fandom.com/wiki/Berserker"
image_path: cards/images/berserker.png
scraped_at: "2026-09-02T02:34:46+00:00"
hero_file: heroes/berserker-hero.md
arena: Jungle Arena
release_date: 3 February 2025
---

# Berserker

> *In-game description:* "It's surprising how often she needs her axes sharpened, but then again, if you liked hitting things as fast as her, so would you."

**Related:** [Hero variant: berserker-hero](../heroes/berserker-hero.md)

## Overview

The Berserker is a Common card that is unlocked from the Jungle Arena (Arena 9) It spawns a fast, single-target, ground-targeting, melee, ground troop with moderate hitpoints and low damage. She appears as a kid who wears a brown dress made of bear skin and wristbands and a team-colored belt, has orange hair with two buns, eyes and eyebrows, a loose tooth, and a scar on her left chin, arms and legs, and wields a pair of cleavers. A Berserker card costs 2 Elixir to deploy.
...
If her **Hero** is active, you can spend 3 Elixir to use her **Savage Survival** ability. creating a strong connection with her spiritual bear. This will increase her movement speed, attack speed, and damage, while making her undestroyable! Her invincibility allows her to shred any and all units in her path, no matter if big or small!

## Attributes

**Attributes**

| Cost | Hit Speed | First Hit Speed | Speed | Deploy Time | Range | Target | Count | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|
| 2 | 0.6 sec | 0.2 sec | Fast (90) | 1 sec | Melee: Short (0.8) | Ground | x1 | Ground | Troop | Common |
...
#### Common: Beatdown Boulevard
> "+200% hit speed"
Berserker's attack speed is increased by 200%, for a total of 0.2 seconds.
#### Rare: Don't Get in Her Way
> "Charge attack"
Berserker's charges an attack similarly to a Bandit.
#### Epic: Mutilation Meditation
> "Heal on attack"
Berserker heals herself when she attacks.
...
This card has a Hero form (Savage Survival, ability cost 3 Elixir): see [berserker-hero.md](../heroes/berserker-hero.md).
...
- clock 2:31 (t=23.0, tile [3, 13]) and clock 2:19 (t=35.0, tile [2, 14]): two early 2-elixir drops on his own left half into the opponent's Archers at tiles [4, 21] / [3, 16].
- clock 1:17 (t=97.3, tile [1, 14]): played alongside the Skeleton Army in the Royal Hogs defence — "Let's go for the Berserker here. Go for the Skeleton Army."
- clock 0:20 (t=151.7, tile [4, 13]): triple-elixir cycle placement — "Go for the Berserker here." No Hero ability was used in this game: there is no unattributed 3-elixir own elixir drop anywhere and he never mentions an ability, so this is the plain 2-elixir card.
...
- clock 2:48: opening play of the match, dropped straight onto the opponent's Princess — "playing a log bait. I'm just going to go for the Berserker here on top of that Princess."
- clock 1:01: held centrally at (8, 9) as an answer in waiting rather than spent — "We have berserker here ready in the middle in case he goes for this."
- overtime clock 1:29: used as the cheap answer to a tank that was placed in front of its support — "I can berserker this cuz that's in the front. I was going to eat that, but because he messed up and put it in the front, then I was fine with it."
- overtime clock 1:12 and 0:55: added on top of a connecting push for extra tower damage — "I'm going to berserker here as well just to get on the tower, grab some extra damage" and "I'm going to berserker the bridge here." Every HUD play in this game is a clean 2-elixir step; no 3-elixir no-hand-change step appears, so the Hero variant's Savage Survival ability is not confirmed here.
...
- clock 2:49 (t=492.0) and clock 1:52 (t=545.0): defensive deep placements at tiles [3, 12] and [3, 5], part of the all-in answer to the opening Hog Rider — "Just going to go for everything on defense here just to make sure that hog rider doesn't grab a shot."
- clock 1:39 (t=561.2): Berserker at the bridge tile [15, 13] (HUD, 4.0 -> 2.0) with a Dart Goblin behind it, played for tower-activation denial — "Let's go for the berserker here at the bridge. I just want to try to prevent a king activation... It's going to be really hard to prevent a king activation whenever they have such a quick cycle."
- clock 1:33-1:25 (t=568-574): the Hero ability is delayed on purpose, then popped to walk her onto the tower — "Do I want a berserker ability? Yeah, I definitely do. I'm going to wait a second. Let's berserker ability now so I can hesitate. Nice, and now I can get on the tower. That is a lot of damage." The enemy right tower falls 4858 -> 2516 across that window.
- clock 1:09 (t=591.6), clock 0:31 (t=631.6) and clock 0:10 (t=650.6): repeat placements at [13, 13], [9, 0] and [3, 13], used to kill support and to start the counter-push — "we can go for the Berserker here, too, just to make sure that we take out this Musketeer"; "Berserker here in the back and now we grab the damage."
...
- clock 2:41: his opening defensive answer, deep on his own left — deploy label 'eRseRkeR' at [1, 7]. "Let's go for the Berserker here just to take this out. Hopefully don't take too much damage" (t=717-720).
- clock 2:07 and 0:23: his prediction card, both times called before the opponent's swarm lands — labels at [14, 2] and [14, 15]. "I'm going to go for a Princess plus Berserker here just to maybe grab the gang or the skellies. Nice. Beautiful prediction" (t=751-756); "I'm going to berserk here for the princess. Nice. Great prediction right there" (t=851-853).
- Hero variant (Savage Survival, 3 elixir): he treats the ability as a real spend, declining it twice — "Wait, not going to pop the ability" (t=758-760) and "Don't think I want to grab the berserker ability" (t=846) — then spending it on the bridge Berserker at clock 0:23 (a 5-elixir drop with no hand change = 2 + 3) and twice more trying to break the opponent's Inferno Tower: "Wait, Berserker ability. Come on, take out the Inferno Tower" (t=933-936) and "Let's Berserker then we can go for the ability here as well" (t=963-965). It does not work: "this Inferno is just unresettable" (t=942).
- clock 1:29 and OT 1:10: also used as the opposite-lane pressure card in his bait rotation (label at [3, 13]) and as a bridge-side threat on the opponent's half (label at [12, 19], "Let's go for the Berserker here and then we go for the Skarmy in the middle as well", t=928-930).
...
- clock 2:21: one play at tile [8, 0], his own back line behind the King Tower, at 9 elixir with a Royal Ghost walking the left lane - a cycle/pressure placement rather than a block. No commentary on it.
- The play costs -2 (the base card's cost) and there is no unexplained own -3 elixir drop anywhere in this game, so nothing here shows the Heroic Berserker's 3-elixir Savage Survival ability being used - the hero variant is neither confirmed nor ruled out in this window.
...
- clock 0:58: Berserker at tile [14, 13] used as the answer to the opponent's crossing Princess — "I'm going to berserker for this princess."
- clock 0:36: Berserker at tile [14, 13] as the follow-up behind the Mega Knight and Evolution Goblin Barrel — "Okay, I'm going to go for the mega knight here. I'm just going to apply some pressure. Let's berserker as well."
- clock 0:07: Berserker at tile [14, 5] on his own half as a block against goblins from a barrel — "I think I have to get a berserker down on the barrel. I think I might lose to be honest."
...
- clock 2:37, 2:07, 2:00, 1:34, 1:12, 0:51, 0:42, 0:32: eight deployments in 161 readable seconds, split between a right-lane bridge body at [14, 14] / [12, 13] leading Spear Goblins and Wall Breakers, and a left-pocket defensive body at [3, 8] / [1, 13] / [2, 8] against Lava Hound pups and Skeleton Dragons — the 2-elixir cost is what lets him replay her every cycle.
- clock 2:30 and 1:07: the Hero's Savage Survival ability (3 elixir, no card leaves the hand) is spent purely for survivability, never as a damage burst — 'Let's pop our ability here right now, actually, just to keep it alive and tank for our troops for a little bit longer' (36s) and 'I'm going to ability here, guys, cuz it's going to tank for my spear goblins' (118s). A third, unnarrated 3-elixir drop lands at 2:14.
- clock 1:07-1:01: with the ability running, his Berserker beats the opponent's own Berserker and the enemy right tower runs 1224 -> 109 in eight seconds — 'his berserker instantly died and we get some damage on the tower. That's tower down because of the ability' (121-124s).
- clock 1:57-1:47 and 1:29-1:25, on the card in general: 'definitely very counterable, which is something that I like, but it seems super strong when your opponent is either really low on elixir or if you're like on defense'; 'The ability is three elixir, which is pretty pricey in my opinion, but you get a lot of utility out of it'; and 'you can't really just ignore Berserkers cuz the Berserker naked will deal nearly your entire tower.'
...
- Played as the Hero Berserker throughout (heroes/berserker-hero.md, 2 elixir + 3 for Savage Survival), and the video's thesis is that she is a siege card: "the hero berserker is pretty strong in siege decks… typically when you're trying to defend an X-Bow or a mortar you need to put cards at the bridge to be able to attack it. But when you have the hero berserker, you can pop the ability and get a few seconds of invincibility plus a crazy spurt of damage, which can usually end up getting you an X-Bow or a mortar connection" (t=182-204).
- clock 2:17-2:15 (t=207.7, 210.2): Berserker at [14, 14] at the bridge beside a fresh X-Bow, then the ability — "let's go for the ability here, guys. And look at this. It's going to completely wipe out everything" — which erases the opponent's defending Tesla: "Look at that Tesla. Oh my god. It's already gone" (t=215). His generalisation: "you can just instantly wipe out their defenses and they just don't have enough elixir to kind of recoup" (t=227-233).
- clock 1:22 and 0:42 (t=262.3, 303.0): bridge Berserkers at [15, 14] and [5, 14], the first purely to bait the Rocket ("Let's berserker here just to make him rocket… later in the game I can just rocket cycle him anyway", t=263-268), the second with the ability held for the duel — "Let's berserker, skellies, e-spirit and then we can pop the ability just to win the one-v-one. Look, that's going to take out his Evo Tesla" (t=304-308).
- overtime 1:06 to 0:38 (t=399.2, 407.4, 426.4): used defensively at [12, 7] and [14, 4] and as a blocker ("another berserker here to block his next Tesla", t=427), and the ability spent on the opponent's own Hero Berserker — "Let's ability here to instantly wipe out his berserker. Yo, his berserker's going to insta-die" (t=421-425). He also notes the cost oddity: "the ability being three elixir is interesting, cuz the ability costs more than the actual card" (t=363-366), and, from the defender's side, that Berserker + ability into an X-Bow is "five whole elixir" and probably distractable (t=321-333).
...
- clock 2:45 to OT 1:38 (Hero form, 'Savage Survival'): five deployments, all left lane — [3, 10] and [4, 10] as defensive bodies on his own half, and [3, 15], [2, 15], [2, 14] at the river as the Graveyard's tank. She is never sent alone at a tower; every river placement is within 1-2 s of a Graveyard cast.
- clock 2:33: the ability is what makes the Graveyard playable for him — 'Normally I wouldn't, but because I have the ability... I can pop the ability now, keep it alive, but it's going to tank for the graveyard for a decent amount of time to get us some extra damage, maybe a shot.'
- clock 1:11: pops it on defence and gets the game's biggest damage swing (enemy left tower 2809 -> 1560 across clock 1:09-1:05): 'Let's pop the ability here... look the berserker. Oh my god, it killed the spirit. Look at all that damage. Okay, maybe there isn't a reduction.' Earlier, at clock 2:03, he had read it the other way: 'It looks like it does reduce tower damage whenever it's in the ability... it would do more if there wasn't a reduction' (the hero card confirms -75% Crown Tower damage for 4 s).
- OT 1:31: the winning sequence is Berserker first, then Graveyard, then the ability — 'maybe we don't graveyard at all. Maybe we need to Berserker first. Berserker graveyard here and then if we pop the ability, it should just live long enough to take the tower... GG's. Nice win.' He also declines the ability once, at clock 0:41 ('Nah, we can't ability'), and rates the 3-elixir cost as forgiving: 'you do have room to do bad abilities' (clock 0:13).
...
- clock 2:51-0:15: the Hero Berserker (see heroes/berserker-hero.md) is his 2-elixir defensive body, dropped on his own half at (3, 12), (8, 10), (9, 8), (12, 8), (9, 10) and (14, 3) rather than as a bridge unit; he only pokes with her at the bridge (13, 15) at clock 0:27 once the tempo has flipped - "then we can go for the Berserker at the bridge".
- clock 2:40: Savage Survival used on defence (own elixir 8 -> 5 with no card leaving hand) and it wins the exchange outright - "Also, wall breakers don't want to hit my ability here. Oh my god, what an ability right there. Taking out his Berserker and nearly the dark goblin." A second activation follows at clock 1:45 - "Think I'm going to have to ability again."
- clock 0:04 (overtime opening): a deliberately high Berserker at (9, 14) placed to body-block an expected enemy Dart Goblin snipe on his own Dart Goblin - "I know he's going to try to Dark Goblin my Dark Goblin so go for the high Berserker here to block it. Great prediction."
- overtime 1:25: with 3 elixir he chooses a second Berserker over the ability - "I might want to Berserker ability. Hold on. Let's Berserker again instead. Just keep up the pressure." Against a mirror Berserker he also plays around the enemy's ability: "He might pop the ability so I have to be careful. Okay, I think next time I should maybe Berserker high just in case he abilities" (clock 0:15-0:11).
