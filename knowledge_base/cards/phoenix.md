...
source_url: "https://clashroyale.fandom.com/wiki/Phoenix"
image_path: cards/images/phoenix.png
...
> *In-game description:* "This mystical creature will be reborn as an egg when destroyed. If it hatches, it returns to the fight! What an egg-cellent ability."

## Overview

The Phoenix is a Legendary card that is unlocked from the Spooky Town (Arena 12).  It spawns a single-target, air-targeting, melee, air troop with moderate hitpoints and moderate damage. When defeated, the Phoenix explodes, dealing damage, inflicting knockback, while spawning an egg which has low hitpoints. If the egg is not defeated within 3.8 seconds, it will hatch into another Phoenix with the original's hitpoints and damage. However, a reborn Phoenix does not deal death damage or spawn an egg once it is defeated. It is a cerise bird with slate eyes, yellow sclerae, a maroon beak and legs, and amber eyebrows, remiges and rectrices. A Phoenix card costs 4 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
At the hot price of 4 Elixir, this majestic flying bird fills his role as figurative and literal heat. He packs moderately low health, with decent damage, and to compensate, he will lay an Egg (topped with death damage) when he dies. The egg has low health, and if it isn't destroyed quick enough, it (unsurprisingly, but epicly) spawns a brand new Phoenix (that can’t lay another egg). One should consider protecting the egg it lays with a mini-tank. But if they do, they'll consider small spells to extinguish out the fire it lays. Just don’t expect anything that does the same or less damage compared with The Log to do the trick in one hit.

## Attributes

**Attributes**

| Cost | Hit Speed | First Hit Speed | Speed | Deploy Time | Spawn Speed | Range | Death Damage Splash Radius | Target | Count | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 1 sec | 0.5 sec | Medium (60) | 1 sec | 3.8 sec | Melee: Long (1.6) | 1.5 | Air & Ground | x1 | Air | Troop | Legendary |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Damage | Damage per second | Death Damage | Phoenix Egg Hitpoints |
|---|---|---|---|---|---|
| 9 | 869 | 179 | 179 | 135 | 198 |
| 10 | 956 | 197 | 197 | 148 | 218 |
| 11 | 1052 | 217 | 217 | 163 | 240 |
| 12 | 1157 | 239 | 239 | 179 | 264 |
| 13 | 1273 | 263 | 263 | 197 | 290 |
| 14 | 1400 | 289 | 289 | 217 | 319 |
| 15 | 1540 | 318 | 318 | 239 | 351 |
| 16 | 1694 | 349 | 349 | 263 | 387 |
