...
source_url: "https://clashroyale.fandom.com/wiki/Royal_Ghost"
image_path: cards/images/royal-ghost.png
scraped_at: "2026-09-02T02:35:09+00:00"
evolution_file: evolutions/royal-ghost-evolution.md
arena: Spooky Town
...
> *In-game description:* "He drifts invisibly through the Arena until he's startled by an enemy... then he attacks! Then he's invisible again! Zzzz."

**Related:** [Evolution: royal-ghost-evolution](../evolutions/royal-ghost-evolution.md)

## Overview

The Royal Ghost is a Legendary card that is unlocked from the Spooky Town (Arena 12). It spawns a fast, area-damage, ground-targeting, melee, ground troop with high hitpoints and high damage. Upon deployment, he will spawn invisible, and will only turn visible once he attacks. If he is in his invisible state, he will not be targeted by opposing units, but can still be hit by area damage or spells. When he is not fighting any unit for 1.8 seconds, he will become invisible again. The Royal Ghost hovers, meaning he is targeted as a ground unit, but travels similar to air units. The Royal Ghost resembles an undead King who has pale skin, puffy eyes, white eyebrows, mustache and beard, wears a crown, dark gauntlets and chain mail, a team-colored robe and shoes, and a belt, and wields a light blue glowing sword. A Royal Ghost card costs 3 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
A vengeful spirit is haunting the Arena! For 3 Elixir, he has moderate hitpoints & area melee damage and can become invisible, being fully unable to be targeted by troops or buildings. He strikes enemies and towers before they even see him and clears swarms with ease. He can also move over the river. However, he has a slow attack speed, leaving him susceptible to other mini-tanks.

All is not lost, however. For 2 Cycles, if his **Evolution** is active, he gains a new, spooky ability from the other realm: **Souldier Summoning**. Every time he attacks while invisible, he summons two Souldiers to deal spawn damage exactly on the radius where Royal Ghost attacked. The spawn damage, each Souldier’s health and damage are all a Skeleton’s worth. Although Souldiers can also spookily go invisible when idle, they’re indeed fragile.
...
This card has an evolution: see [royal-ghost-evolution.md](../evolutions/royal-ghost-evolution.md). Cycles to evolve: 2. Stat boosts: N/A.
...
- **[Cycle](../archetypes/cycle.md)** — 2 deck(s): [EvoRHogs AQ GobHut EvoGhost](../decks/archer-queen-barbarian-barrel-electro-spirit-fireball-goblin-hut-royal-ghost-royal-hogs-skeletons.md), [EvoRG FishBoy Hunter 3.0 Cycle](../decks/barbarian-barrel-electro-spirit-fireball-fisherman-hunter-royal-ghost-royal-giant-skeletons.md)
