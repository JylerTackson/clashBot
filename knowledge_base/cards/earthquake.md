...
source_url: "https://clashroyale.fandom.com/wiki/Earthquake"
image_path: cards/images/earthquake.png
scraped_at: "2026-09-02T02:35:17+00:00"
arena: Spooky Town
release_date: 15 April 2019
---

# Earthquake

> *In-game description:* "Deals Damage per second to Troops and Crown Towers. Deals huge Building Damage! Does not affect flying units (it is an EARTHquake, after all)."
...
| Level | Area Damage | Crown Tower Damage | Building Damage |
|---|---|---|---|
| 3 | 39 x3 (117) | 25 x3 (75) | 134 x3 (402) |
| 4 | 43 x3 (129) | 27 x3 (81) | 147 x3 (441) |
| 5 | 47 x3 (141) | 30 x3 (90) | 162 x3 (486) |
| 6 | 52 x3 (156) | 33 x3 (99) | 178 x3 (534) |
| 7 | 57 x3 (171) | 36 x3 (108) | 196 x3 (588) |
| 8 | 63 x3 (189) | 40 x3 (120) | 216 x3 (648) |
| 9 | 69 x3 (207) | 44 x3 (132) | 237 x3 (711) |
| 10 | 76 x3 (228) | 48 x3 (144) | 261 x3 (783) |
| 11 | 84 x3 (252) | 53 x3 (159) | 287 x3 (861) |
| 12 | 92 x3 (276) | 58 x3 (174) | 316 x3 (948) |
| 13 | 102 x3 (306) | 64 x3 (192) | 347 x3 (1041) |
| 14 | 112 x3 (336) | 71 x3 (213) | 382 x3 (1146) |
| 15 | 123 x3 (369) | 78 x3 (234) | 420 x3 (1260) |
| 16 | 135 x3 (405) | 85 x3 (255) | 462 x3 (1386) |
...
- clock 0:08: cast at [12, 21] in the opponent's half right behind a Hog Rider at [16, 15]; enemy right tower falls 3657 -> 2916 in four seconds. 'Let's just go for the Earthquake here just to take out that side and apply some more pressure' (t=166-167).
- OT 0:57: used as a pre-emptive Skeleton Army answer at [14, 22] rather than as chip, paired with a bridge Hog — 'let's go for the earthquake here as well, so [he] can't skeleton army' (t=237-238); enemy right 2294 -> 1802 -> 1091.
- OT 0:29: the same prediction again at [13, 21] behind a Hog at [10, 14], and it lands — 'earthquake here for the skeleton army. Nice. Oh my god, great prediction' (t=264-267). The final call at OT 0:23 closes the game: 'we just have to go for the earthquake. Let's go. Very nice win' (t=271-272).
- Deck slot: this is the eighth card, not Heal Spirit. Ryley names the list 'the best Hog Rider Earthquake deck' at t=9 and calls 'earthquake' in the first person four more times; the pipeline logged all three casts as opponent plays even though every one lands deep in his opponent's half immediately after his own play call.
...
- clock 1:07: Earthquake opens the comeback sequence, cast at (2, 6) and immediately followed by the Hog Rider — "Okay, let's go for the earthquake here, then we can go for the hog rider, and then we just go for a late e-spirit in the back" (383-387s); enemy right tower 3844 -> 3337 over the next ten seconds.
- overtime 1:38: cast at (14, 6) on his own half purely as a defensive answer to the ground push, as the first card of a four-card defence — "Okay, just earthquake here on defense. We can skellies inside and then we have to go for the log and we have to cycle to our evo cannon if we want to be able to defend this" (474-479s).
- overtime 1:08: same defensive role on the other lane at (3, 6), paired with a body block — "Okay, let's e-spirit here. Let's earthquake then we go for the high mighty miner to block this" (504-505s).
- overtime 0:53 and 0:24: two offensive casts at (12, 20) on the opponent's half behind the Hog Rider, the first written off ("We need to pre-log here for the barbs or the bowler. Let's earthquake here as well... Aw, that's not going to get a hit though, sadly", 516-522s) and the second winning the match as the enemy right tower goes 424 -> 118 — "Earthquake. Oh my god, I think we got it. Yes. Let's go. What a comeback, man" (547-551s).
...
- clock 2:47: Earthquake follows his opening bridge Hog Rider by 1.5 s, deploy label at (14, 19) on the opponent's half in the Hog's own right lane and on the tower it is running at - the standard Hog-plus-Earthquake opener. He does not name the spell in this game's commentary; the pipeline booked the -3 elixir step against the opponent's estimate, and the read that it is his rests on the tile half, the lane pairing and the video-level reconciliation across the six games (see the match file's Data gaps).
- clock 2:47 to 0:03: it is the only Earthquake in the 170 readable seconds - the rest of the game is defence with Cannon, Skeletons, Electro Spirit and The Log, so no defensive Earthquake use is observed here.
...
- clock 1:25: casts it on the Tesla while deliberately overspending behind a Hog Rider push - "I'm just going to go for the Earthquake here on the Tesla, guys, cuz I know I can overspend here and get away with it. Cuz he won't be able to expo since he has to spend all of his Elixir on defense right now" (812-820s); elixir fell 9 -> 3 for Firecracker plus one 3-cost spell and an Earthquake landed on the opponent's half at (11, 19).
- clock 0:21: uses it as bait for the siege - "I kind of want to go for the Earthquake to bait him into going for an expo, but I think he's going to end up having to go for the expo regardless. Let's just Earthquake here" (870-875s).
- overtime: throws it behind the Hog Rider to break the defensive building - "I'm going to go for the Hog Rider here and then we can go for the Earthquake as well just to make sure we drop the Tesla" (909-913s), a 3-elixir drop followed by an Earthquake at (6, 18).
- clock 2:44, 2:19 and 1:37: three further Earthquakes land on the opponent's half at (4, 20), (2, 21) and (2, 20) before the commented ones — six of the seven Earthquake events in this game are on the enemy side, and the pipeline attributed all of them to the opponent. Earthquake, not Heal Spirit, is the deck's eighth card; the single read on Ryley's own half at (4, 5) arrives one second after the (2, 20) cast and is most likely a duplicate detection.
...
- clock 2:25 (t=967): cast into the middle of the opponent's half at tile [9, 20] behind a bridge Hog Rider, aimed at the defending Cannon - 'very good earthquake right there. I like to go for those middle earthquakes in this match up. I feel like they're just value. You almost always get a nice hog rider hit out of it if they're not prepared'.
- clock 1:36 (t=1016): deliberately delayed rather than cast on the Cannon on sight - 'I'm not going to earthquake the cannon immediately though. I'm going to hog now. I'm just going to wait cuz he might cannon off to the side this time' - then dropped it at [3, 21] once the opponent committed the Cannon centrally again.
- clock 1:59 and 1:17 (t=1113, 1154): in overtime he ran the same Hog-plus-Earthquake pattern at [6, 19] both times - 'we go for the hog rider here and then we go for the earthquake here. Make sure that we try to take out this cannon and we need to try to grab a shot'.
- clock 0:47 (t=1183): stacked it on top of a Firecracker that had just killed the Musketeer, at [4, 21], and the enemy left tower fell 3764 -> 3546 - 'Let's earthquake this as well and then we can go for the Evo Cannon, too'. Note: the pipeline auto-attributed these five deploy labels to the opponent because they land on the opponent's half; they are narrated in first person and are Ryley's own (see the match file's Data gaps).
...
- clock 1:34: Earthquake onto the enemy tower/Goblin Cage area (deploy labels at tiles [5, 21] and [7, 25]) used as a probe for the opponent's list — "Okay, I'm just going to Earthquake here. He could cycle his Evo Cage. I think this will tell us a bit more about his win condition though."
- overtime clock 1:48: takes it as free value when the opponent's building is not down, and immediately prices the counter-trade — "Ooh, that's a free earthquake though. I will take this ... He could grab a free lightning though cuz we grabbed the free earthquake. That'd be good for him."
- clock 0:27 and 0:07: the finishing chip in an overtime race, at tiles [3, 22] and [3, 21] — "Let's earthquake here" and "we need to earthquake and then we need a log" — while the enemy left tower runs 653 -> 129 HP.
