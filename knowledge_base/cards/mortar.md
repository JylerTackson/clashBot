...
source_url: "https://clashroyale.fandom.com/wiki/Mortar"
image_path: cards/images/mortar.png
scraped_at: "2026-09-02T02:35:31+00:00"
evolution_file: evolutions/mortar-evolution.md
...
> *In-game description:* "Defensive building with a long range. Shoots big boulders that deal area damage, but cannot hit targets that get very close!"

**Related:** [Evolution: mortar-evolution](../evolutions/mortar-evolution.md)

## Overview

The Mortar is a Common card that is unlocked from the Builder's Workshop (Arena 5). It spawns an area-damage, ground-targeting, very long-ranged, building with high hitpoints and high damage. It has a blind spot, preventing it from attacking enemies inside it. It is a black cylindrical tube with a metal base, a wooden gimbal on each side with a stud on them which are held by iron stakes and a metal disc, and a large team-colored band near the muzzle. A Mortar card costs 4 Elixir to deploy.
...
It's quite hard to stop these explosive shells from hitting a tower and dealing quite a bit of damage thanks to its blind spot; any enemy troop that gets too close will be ignored. The ability to snipe towers, its moderate hitpoints, and the light cost of 4 Elixir make this building versatile, though its incredibly slow hit speed means it often needs additional support against any unit that isn't one shot by its attack.
 ...
 For 2 Cycles, if its **Evolution** is active, the **Green Siege** technique gives Mortar a new ammunition: Goblins! When the Mortar fires its quicker shots, a Goblin comes where it lands. I mean, the rent price is low for the cost of extra enemy stabbing.

## Attributes

**Attributes**

| Cost | Hit Speed | First Hit Speed | Deploy Time | Lifetime | Range | Splash Radius | Projectile Speed | Target | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 5 sec | 1 sec | 3.5 sec | 30 sec | 3.5-11.5 | 2 | 300 | Ground | Building | Common |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Hitpoints lost per second | Area Damage | Damage Per Second |
|---|---|---|---|---|
| 1 | 528 | 17.6 | 103 | 20 |
| 2 | 581 | 19.4 | 113 | 22 |
| 3 | 639 | 21.3 | 124 | 24 |
...
#### Common: On the Up & Up
> "+200% hit speed"
Mortar's attack speed is increased by 200%, for a total of 1.66 seconds.
#### Rare: Be the Boulder
> "Barbarian launcher"
Instead of a Mortar, a Barbarian Launcher is spawned.
#### Epic: A Mystical Mystery
> "Invisible Mortar"
The Mortar is invisible.
