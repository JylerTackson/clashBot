...
source_url: "https://clashroyale.fandom.com/wiki/Cannon"
image_path: cards/images/cannon.png
scraped_at: "2026-09-02T02:35:30+00:00"
evolution_file: evolutions/cannon-evolution.md
...
> *In-game description:* "Defensive building. Shoots cannonballs with deadly effect, but cannot target flying troops."

**Related:** [Evolution: cannon-evolution](../evolutions/cannon-evolution.md)

## Overview

The Cannon is a Common card that is unlocked from the Barbarian Bowl (Arena 3). It spawns a single-target, ground-targeting, medium-ranged, building with moderate hitpoints and moderate damage. It appears as a large dark metal barrel mounted on a four-legged wooden mount with a metal plate and a crude, with two team-colored ridges, one midway and the other at the rear. A Cannon card costs 3 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
For 3 Elixir, you get a building which has moderate hitpoints, damage and range. Doesn't seem like much, does it? Well, when you see how much potential this building has for such a low cost, you'll reconsider and use it nearly every time.

 After 2 Cycles, if its **Evolution** is active, the Cannon learns a new skill from the Eagle Artillery: **Barrage Carnage**! When deployed, the Cannon shoots 9 barrage shots (5 in the most distant position and 4 in the closest position). Half of the shots hit the other side, and all of the shots knock back, making it great for offense and defense.

## Attributes

**Attributes**

| Cost | Hit Speed | First Hit Speed | Deploy Time | Lifetime | Range | Projectile Speed | Target | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|
| 3 | 1 sec | 1 sec | 1 sec | 30 sec | 5.5 | 1000 | Ground | Building | Common |
...
| 12 | 906 | 30.2 | 233 | 233 |
| 13 | 997 | 33.2 | 257 | 257 |
| 14 | 1097 | 36.6 | 282 | 282 |
| 15 | 1206 | 40.2 | 310 | 310 |
| 16 | 1327 | 44.2 | 341 | 341 |
...
This card has an evolution: see [cannon-evolution.md](../evolutions/cannon-evolution.md). Cycles to evolve: 2. Stat boosts: N/A.
...
- **[Cycle](../archetypes/cycle.md)** — 3 deck(s): [EvoRHogs AQ EvoCannon 2.9 Cycle](../decks/archer-queen-cannon-earthquake-ice-spirit-royal-delivery-royal-hogs-skeletons-the-log.md), [Hog MM EvoCannon 2.6 Cycle](../decks/barbarian-barrel-cannon-earthquake-electro-spirit-firecracker-hog-rider-mighty-miner-skeletons.md), [Hog HeroMusk 2.6 Cycle](../decks/cannon-fireball-hog-rider-ice-golem-ice-spirit-musketeer-skeletons-the-log.md)
