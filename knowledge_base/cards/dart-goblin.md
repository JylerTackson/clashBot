...
source_url: "https://clashroyale.fandom.com/wiki/Dart_Goblin"
image_path: cards/images/dart-goblin.png
scraped_at: "2026-09-02T02:34:56+00:00"
evolution_file: evolutions/dart-goblin-evolution.md
arena: Jungle Arena
release_date: 13 January 2017
---

# Dart Goblin

> *In-game description:* "Runs fast, shoots far and chews gum. How does he blow darts with a mouth full of Double Trouble gum? Years of didgeridoo lessons."

**Related:** [Evolution: dart-goblin-evolution](../evolutions/dart-goblin-evolution.md)

## Overview

The Dart Goblin is a Rare card that is unlocked from the Jungle Arena (Arena 9). It spawns a very fast, single-target, air-targeting, long-ranged, ground troop with low hitpoints and low damage. He resembles a Goblin, but wears a voodoo mask with red eyes, team-colored face paint and a rope behind, and leaves with team-colored tips, and holds a blowgun. A Dart Goblin card costs 3 Elixir to deploy.
...
For 2 Cycles, if his **Evolution** is active, you'll notice that he learnt the final skill of didgeridoo classes: **Ob-noxious Darts**! The improved and intoxicated Dart Goblin deals weak damage over time with one dart, but they can ramp up to a stage 2 poison after 3 darts, and a stage 3 poison after 3 more darts. This resets when the Dart Goblin targets another troop instead, but the poison will stay until the targeted troop's eventual demise! The clouds that the poisonous troops leave last for one second, which is enough to damage anything nearby, wiping out even the toughest of pushes!
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 3 | 0.8 sec | 0.35 sec | Very Fast (120) | 1 sec | 6.5 | 800 | Air & Ground | x1 | Ground | Troop | Rare |
...
#### Common: Speedy Goblinez
> "+100% movement speed"
Dart Goblin's attack speed is increased by 100%, for a total of 0.4 seconds.
#### Rare: Call Him Darcher
> "Magic Archer darts"
Dart Goblin's attacks pierce through enemies, identically to a Magic Archer.
#### Epic: Shocking Gum
> "Sparky darts"
Dart Goblin's attacks deal area damage, identically to a Sparky.
...
This card has an evolution: see [dart-goblin-evolution.md](../evolutions/dart-goblin-evolution.md). Cycles to evolve: 2. Stat boosts: N/A.
