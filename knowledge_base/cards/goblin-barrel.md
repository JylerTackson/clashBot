...
source_url: "https://clashroyale.fandom.com/wiki/Goblin_Barrel"
image_path: cards/images/goblin-barrel.png
scraped_at: "2026-09-02T02:35:28+00:00"
evolution_file: evolutions/goblin-barrel-evolution.md
...
> *In-game description:* "Spawns three Goblins anywhere in the Arena. It's going to be a thrilling ride, boys!"

**Related:** [Evolution: goblin-barrel-evolution](../evolutions/goblin-barrel-evolution.md)

## Overview

The Goblin Barrel is an Epic card that is unlocked from the P.E.K.K.A's Playhouse (Arena 6). It is a spell, once the spell has hit the ground, it spawns three Goblins. It is a wooden barrel with a Goblin logo on it. A Goblin Barrel card costs 3 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
3 Goblins for 3 Elixir that fly in a barrel that can be thrown anywhere in the Arena — perfect for a surprise attack! If left ignored, it can deal heavy damage to towers for an unparalleled low cost, but these Goblins are easily countered by swarms or spells and are relatively slow to begin attacking.

For 2 Cycles, if its **Evolution** is activate, the **Decoy Barrel** ability causes Goblin Barrel to spawn 2 identical Barrels (besides a purple glow from the fake one). One has 3 Goblins, while the other has 3... Decoys! These decoys dish out less damage, and are super fragile. Together, they can bait out spells and/or get massive damage on one/both sides, but are still very weak to the same counters as the normal Goblin Barrel.

## Attributes

**Goblin Barrel Attributes**
...
|---|---|---|---|---|---|---|---|
| 1.1 sec | 0.4 sec | Very Fast (120) | 1.1 sec | Melee: Short (0.5) | Ground | x3 | Ground |
...
#### Common: Cannonball!
> "Impact damage"
The Goblin Barrel deals damage when it lands, similarly to a Fireball. Its area radius is also increased.
#### Rare: Double Barrel
> "x2 Goblins"
The Goblin Barrel shoots two waves instead of one.
#### Epic: Muscle Mates
> "3 Goblin Brawlers"
Instead of Goblins, the Goblin Barrel spawns Goblin Brawlers.
...
This card has an evolution: see [goblin-barrel-evolution.md](../evolutions/goblin-barrel-evolution.md). Cycles to evolve: 2. Stat boosts: +1 Barrel.
