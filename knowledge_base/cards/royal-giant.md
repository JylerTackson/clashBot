...
source_url: "https://clashroyale.fandom.com/wiki/Royal_Giant"
image_path: cards/images/royal-giant.png
scraped_at: "2026-09-02T02:34:45+00:00"
evolution_file: evolutions/royal-giant-evolution.md
arena: Royal Arena
...
> *In-game description:* "Destroying enemy buildings with his massive cannon is his job; making a raggedy blond beard look good is his passion."

**Related:** [Evolution: royal-giant-evolution](../evolutions/royal-giant-evolution.md)

## Overview

The Royal Giant is a Common card that is unlocked from the Royal Arena (Arena 7). It spawns a slow, single-target, building-targeting, medium-ranged, ground troop with high hitpoints and high damage. His appearance is similar to that of a Giant, but he sports a dark navy coat with team-colored cuffs, has a mustache and bigger mutton chops, wears a crown and a chainmail, wields a Cannon with two gold ridges in the middle in one hand, and carries a cannonball in the other. A Royal Giant card costs 6 Elixir to deploy.
...
For 1 Cycle, if his **Evolution** is active, he brings a larger cannon and upgrades his ammunition to fancy, giant golden cannon balls! Talk about luxury! It's so awesome, everytime he fires one of those giant cannon balls, the **Royal Shockwave** ability will activate and create a shockwave around the Royal Giant that knocks back everyone near him, protecting himself from swarms and stalling slow units with each recoil. Keep in mind that his recoil doesn't work against air units!
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 6 | 1.8 sec | 0.9 sec | Slow (45) | 1 sec | 5 | 1000 | Buildings | x1 | Ground | Troop | Common |
...
#### Common: Splish Splash Splosh
> "Splash damage"
Royal Giant's bullet does an area of effect.
#### Rare: Look Out, Over There!
> "+200% range"
Triples range.
#### Epic: Let Loose the Hogs of War
> "Royal Hog Projectile"
Shoots out a Royal Hog with every shot.
...
This card has an evolution: see [royal-giant-evolution.md](../evolutions/royal-giant-evolution.md). Cycles to evolve: 1. Stat boosts: N/A.
