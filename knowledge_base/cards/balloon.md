...
source_url: "https://clashroyale.fandom.com/wiki/Balloon"
image_path: cards/images/balloon.png
scraped_at: "2026-09-02T02:35:05+00:00"
hero_file: heroes/balloon-hero.md
arena: Royal Arena
...
> *In-game description:* "As pretty as they are, you won't want a parade of THESE balloons showing up on the horizon. Drops powerful bombs and when shot down, crashes dealing area damage."

**Related:** [Hero variant: balloon-hero](../heroes/balloon-hero.md)

## Overview

The Balloon is an Epic card that is unlocked from the Royal Arena (Arena 7). It spawns a single-target, building-targeting, melee, air troop with high hitpoints and very high damage. When defeated, it drops a bomb which explodes after 3 seconds, dealing moderate damage. It is a hot air balloon with a team-colored envelope and a wooden basket with sacks held together by patches and ropes, and is piloted by a Bomber. A Balloon card costs 5 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
Watch out, an air raid is coming! Having decent hitpoints and high damage per strike, while only targeting buildings, the Balloon makes for a heavy threat on offense. Although it isn’t fast, one strike could potentially mean defeat. For 5 Elixir, it brings death from above and can even blow up a low-health Crown Tower and smaller support troops with its death bomb as a last-ditch effort, as well as pushing back lighter foes.

If its **Hero** is active, you can use its **Coffin Cadet** ability for 2 Elixir, which shoots a Skeletrooper that glides toward the closest ground enemy, dealing splash damage on landing, and continue hitting quite fast and hard for her Elixir cost! But be noted that she can’t glide towards Crown Towers or air units, will be deployed under the Balloon if there’s no ground enemies around, and isn’t the best at damaging Crown Towers.
...
|---|---|---|---|---|---|---|---|---|---|---|
| 5 | 2 sec | 0.2 sec | Medium (60) | 1 sec | Melee: Short (0.1) | Buildings | x1 | Air | Troop | Epic |
...
| 14 | 2235 | 852 | 426 | 319 |
| 15 | 2458 | 937 | 468 | 351 |
| 16 | 2704 | 1031 | 515 | 387 |

## Abilities and special mechanics

### Strategies

- The somewhat sturdy Balloon can easily devastate Crown Towers with its extremely high damage, which is further augmented by a tank protecting it and additional support cards.
...
- In a pinch, a Balloon can be used to counter an X-Bow or a Mortar placed at the bridge. Its high immediate damage allows it to two-shot both buildings, which only takes a few seconds, buying you time to support the Balloon, and its death bomb will also deal notable damage to any extra defenders. However, note that the Balloon is unable to take damage from those buildings, so place down a mini tank like an Ice Golem in range of those buildings to prevent all damage to your Crown Tower.
  - The player should not attempt to execute a LavaLoon push against these X-Bow and Mortar setups, as the Balloon's range is shorter than the Lava Hound's, meaning that it would end up in front of the Lava Hound, leaving it vulnerable. In this case, try to destroy those buildings first before deploying your Balloon.
...
- The Ram Rider and Zappies can counter Balloon fairly well since their stalling makes it harder to reach the Balloon's goal. The former also survives a Fireball, Lightning, and a Rocket, which are common strong spells used to support Balloons.
...
{| class="wikitable" id="unit-attributes-table" style="width:100%; text-align:center;"
! scope="col" |Death Damage Splash Radius
Radius
! scope="col" |Deploy Time
Deploy Time
! scope="col" |Target
...
|1
|Deal a total of 155,000 Damage to enemy Troops or buildings
|20  cards
75 XP
|-
|2
|Deal a total of 460,000 Damage to enemy Troops or buildings
|6,000 Gold
75 XP
|-
|3
|Deal a total of 770,000 damage to enemy Troops or buildings
|100 Gems
75 XP
|-
| rowspan="3" |Tower Tapper

|1
|Hit enemy Crown Towers a total of 350 times
|9,000 Gold
125 XP
|-
|2
|Hit enemy Crown Towers a total of 1,000 times
|20 Epic Wild Card
125 XP
|-
|3
|Hit enemy Crown Towers a total of 1,750 times
|15,000 Gold
125 XP
|-
...
|1
|Hit towers at least 6 times within a single battle a total of 80 times
|6,000 Gold
175 XP
|-
|2
|Hit towers at least 6 times within a single battle a total of 240 times
|8,000 Gold
175 XP
|-
|3
|Hit towers at least 6 times within a single battle a total of 480 times
|10,000 Gold
175 XP
|}
...
This card has a Hero form (Coffin Cadet, ability cost 2 Elixir): see [balloon-hero.md](../heroes/balloon-hero.md).

## Source

- https://clashroyale.fandom.com/wiki/Balloon (scraped 2026-09-02T02:35:05+00:00)
