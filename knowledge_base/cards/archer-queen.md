...
source_url: "https://clashroyale.fandom.com/wiki/Archer_Queen"
image_path: cards/images/archer-queen.png
...
> *In-game description:* "She is fast, deadly and hard to catch. Beware of her crossbow bolts and try not to blink - you might miss her!"

## Overview

The Archer Queen is a Champion card that is unlocked from the Royal Crypt (Arena 17). It spawns a single-target, air-targeting, medium-ranged, ground troop with moderate hitpoints and moderate damage. The Archer Queen's ability makes her invisible, like the Royal Ghost and increases her attack speed significantly for a short time. She appears as an Archer, except she is taller, wears a crown, team-colored wrist cuffs and a loincloth, an olive-colored tunic and cape, has purple hair and eyebrows, carries a bigger quiver, and wields a crossbow with arrows that have golden points as their ammunition, while still being barefoot. An Archer Queen card costs 5 Elixir to deploy, and her ability costs an additional 1 Elixir to activate.

<!-- Card Overviews summary (wiki) -->
The queen and coach of all Archers. A powerful glass cannon rocks the Arena with her crossbow and its mean bolts that she constantly fires slowly for 5 Elixir.

For 1 Elixir, you can use her **Cloaking Cape** ability, mitigating the glass part of her by turning herself invisible, just like the Royal Ghost: unable to be targeted for 3.5 seconds! For the cherry on top, she also increases her fire output for herself drastically while under her invisibility cape, dishing out more impressive loads of damage onto her foes while still being safe inside her hidden cloak! She's vulnerable to heavy spells and large swarms, and walks slower under her maybe heavy cape, but with great power comes great responsibility.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 5 | 1.2 sec | 0.3 sec | Medium (60) | 1 sec | 5 | 800 | Air & Ground | x1 | Ground | Troop | Champion |

**Cloaking Cape Attributes**

| Cost | Speed | Duration | Boost | Cast Time | Ability Cooldown |
|---|---|---|---|---|---|
| 1 | Slow (45) | 3.5 sec | +180% | 0.933 sec | 17 sec |

**Sound Effects**

| Sound Effect | Action | Description | Line |
|---|---|---|---|
| https://clashroyale.fandom.com/wiki/File:AQ_Deployment.wav | Deployment | Plays when the Archer Queen is deployed. | "Ha ha!" |
| https://clashroyale.fandom.com/wiki/File:AQ_Fire_1.wav https://clashroyale.fandom.com/wiki/File:AQ_Fire_2.wav | Attack | Plays when the Archer Queen attacks something. | Archer Queen grunts |
| https://clashroyale.fandom.com/wiki/File:AQ_Hit.wav | Hit | Plays when the Archer Queen hits her target. |  |
| https://clashroyale.fandom.com/wiki/File:AQ_Ability.wav | Ability | Plays when the Archer Queen activates her ability. | "Sneaky!" |
| https://clashroyale.fandom.com/wiki/File:AQ_Defeated.wav | Defeat | Plays when the Archer Queen is defeated. | "But I'm the queen!" |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Damage | Damage per second | Damage per second (with Cloaking Cape) |
|---|---|---|---|---|
| 11 | 1000 | 225 | 187 | 337 |
| 12 | 1100 | 248 | 206 | 372 |
| 13 | 1210 | 272 | 226 | 408 |
...
The Archer Queen has a special ability, accessible from the rightmost side of the screen just above the player's card slots in battle. After a 1-second delay, the Archer Queen activates her “Cloaking Cape”, becoming invisible (untargetable by enemy troops), having a 80% increase in attack speed, and a massive decrease in movement speed for the entire 3.5-second duration of the ability. The ability goes on a 17-second cooldown after the duration ends. The Cloaking Cape ability costs 1 Elixir to activate.
