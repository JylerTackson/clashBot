...
source_url: "https://clashroyale.fandom.com/wiki/Goblinstein"
image_path: cards/images/goblinstein.png
scraped_at: "2026-09-02T02:35:14+00:00"
arena: Silent Sanctuary
release_date: 7 October 2024
---

# Goblinstein

> *In-game description:* "It’s ALIVE! Monster lumbers towards enemy buildings while Doctor waits to spring the trap. At the press of a button, Doctor electrifies the link between himself and Monster, frying nearby enemies!"

## Overview

The Goblinstein is a Champion card that is unlocked from the Silent Sanctuary (Arena 18). It spawns a single-target, air-targeting, medium-ranged, ground troop with moderate hitpoints and low damage, and a single target, building-targeting, melee, ground troop with high hitpoints and low damage. The Goblinstein’s attacks will stun a targeted unit for 0.5 seconds. Being a Champion card, they will stay out of the player's card cycle, and only return once they are defeated. The Goblinstein's ability has him shoot an electric spark towards an antenna that is typically located on the Monster's head. The Goblinstein Doctor resembles a Goblin with white hair, wearing a silver-rimmed team-colored goggles with glowing orange lens, a satellite dish on his head with a team-colored strap, a white coat, tan gloves, and brown boots, and wields a controller. The Monster is a large, green Goblin with a square head with an antenna on top, with some of its body being darker and red and having gold stitches and bolts on them, and wears team-colored pants. A Goblinstein card costs 5 Elixir to deploy and his ability costs an additional 2 Elixir to activate.

<!-- Card Overviews summary (wiki) -->
IT'S ALI-I-I-I-VE! Doctor Goblinstein is a mad scientist ready to drop in the arena with his mad inventions, such as his trusty Monster, delicately crafted with high health and a vendetta for buildings, although Goblinstein forgot that his creation is a bit vulnerable to tank killers when he’s not in. He holds a remote that shoots some lightning, stunning enemies for a split second, while being safely protected by the green hunky creation of a mastermind. These 2 can attack and/or defend one or two lanes, all for only 5 Elixir!

For 2 Elixir, you can use his **Lightning Link**, which is quite shocking for him and the Monster! Goblinstein will link through the monster's antenna, creating an electrical passage between them, dealing a shocking amount of damage to anything brave enough to stand near the electricity for 4 seconds. If his Monster dies, he'll drop his antenna, which will still go on! But if the docter dies, the ability will go away.
...
|---|---|---|---|
| 5 | 1 sec | Troop | Champion |

**Doctor Attributes**

| Hit Speed | First Hit Speed | Speed | Stun Duration | Range | Target | Count | Transport |
|---|---|---|---|---|---|---|---|
| 1.8 sec | 0.5 sec | Medium (60) | 0.5 sec | 5.5 | Air & Ground | x1 | Ground |

**Monster Attributes**

| Hit Speed | First Hit Speed | Speed | Range | Target | Count | Transport |
|---|---|---|---|---|---|---|
| 1.5 sec | 0.8 sec | Medium (60) | Melee: Medium (1.2) | Buildings | x1 | Ground |

**Lightning Link Attributes**

| Cost | Duration | Hit Speed | Target | Radius | Cast Time | Ability Cooldown |
|---|---|---|---|---|---|---|
| 2 | 4 sec | 0.5 sec | Air & Ground | 2 | 0.933 sec | 17 sec |

## Stats by level

**Card Statistics**

| Level | Doctor Hitpoints | Doctor Damage | Doctor Damage per Second | Monster Hitpoints | Monster Damage | Monster Damage per Second | Lightning Link Damage | Lightning Link Crown Tower Damage |
|---|---|---|---|---|---|---|---|---|
| 11 | 721 | 92 | 51 | 2393 | 128 | 85 | 107 | 23 |
| 12 | 793 | 101 | 56 | 2632 | 141 | 94 | 118 | 25 |
| 13 | 872 | 111 | 61 | 2896 | 155 | 103 | 129 | 28 |
| 14 | 960 | 122 | 67 | 3185 | 170 | 113 | 142 | 31 |
| 15 | 1056 | 135 | 75 | 3504 | 187 | 124 | 157 | 34 |
| 16 | 1161 | 148 | 82 | 3854 | 206 | 137 | 172 | 37 |
...
The Goblinstein has a special ability, accessible from the rightmost side of the screen just above the player's card slots in battle. After a 1-second delay, the Goblinstein activates his “Lightning Link”, creating an electric link between him and Monster. It damages by shocking nearby targets every 0.5 seconds up to 2 tiles away. This ability deals reduced damage to the Crown Tower. If the Monster has already been defeated, it will drop an antenna on the ground which is what the Goblinstein's electric link will target when the ability is activated. The Lightning Link ability costs 2 Elixir to activate.
