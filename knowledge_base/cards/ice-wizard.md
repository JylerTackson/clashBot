...
source_url: "https://clashroyale.fandom.com/wiki/Ice_Wizard"
image_path: cards/images/ice-wizard.png
...
> *In-game description:* "This chill caster throws ice shards that slow down enemies' movement and attack speed. Despite being freezing cold, he has a handlebar mustache that's too hot for TV."

## Overview

The Ice Wizard is a Legendary card that is unlocked from the Spooky Town (Arena 12). It spawns an area-damage, air-targeting, medium-ranged, ground troop with moderate hitpoints and low damage. The Ice Wizard's attacks slow the target's movement and attack speed by 30%. Upon deployment, he will deal damage around enemy units around him in a 360º area around him and slow them down similarly to his attack. He resembles a man with cyan spiky hair, fuzzy eyebrows, glowing eyes and hands, and a horseshoe mustache, wearing a brown leather coat and boots and a team-colored suit and a belt. An Ice Wizard card costs 3 Elixir to deploy.

<!-- Card Overviews summary (wiki) -->
Chill out! This Wizard has moderate hitpoints, deals low area damage that slows units and spawns with frost around him that slows enemies (and also deals tiny damage to boot). For 3 Elixir. It may not seem like much, but he can stop enemies in their tracks, making him a nice support troop. Although his slow attack rate and low damage make him ineffective alone, so this chill pill is best used as support.

## Attributes

**Ice Wizard Attributes**

| Cost | Hit Speed | First Hit Speed | Slow Duration | Slowdown | Speed | Deploy Time | Range | Splash Radius | Projectile Speed | Target | Count | Transport | Type | Rarity |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 3 | 1.7 sec | 0.5 sec | 2.5 sec | -30% | Medium (60) | 1 sec | 5.5 | 1.5 | 700 | Air & Ground | x1 | Ground | Troop | Legendary |

**Spawn Damage Attributes**

| Radius | Spawn Slow Duration | Slowdown | Target |
|---|---|---|---|
| 3 | 1 sec | -30% | Air & Ground |

## Stats by level

**Card Statistics**

| Level | Hitpoints | Area Damage | Damage per second | Spawn Damage |
|---|---|---|---|---|
| 9 | 569 | 74 | 43 | 69 |
| 10 | 625 | 81 | 47 | 76 |
| 11 | 688 | 89 | 52 | 84 |
...
#### Common: Splashy Entrance
> "+300% deploy splash"
Ice Wizard's spawn area radius is increased by 300%, for a total of 12 tiles.
#### Rare: Inspired by Snails
> "Permanent slowdown"
Ice Wizard slows troops infinitely.
#### Epic: Simon Says: Freeze!
> "Freeze attacks"
Instead of a slow effect, Ice Wizard's attacks now stun the opponent for 2 seconds.
