...
source_url: "https://clashroyale.fandom.com/wiki/Princess"
image_path: cards/images/princess.png
scraped_at: "2026-09-02T02:35:08+00:00"
evolution_file: evolutions/princess-evolution.md
...
> *In-game description:* "This stunning Princess shoots flaming arrows from long range. If you're feeling warm feelings towards her, it's probably because you're on fire."

**Related:** [Evolution: princess-evolution](../evolutions/princess-evolution.md)

## Overview

The Princess is a Legendary card that is unlocked from the Electro Valley (Arena 11). It spawns an area-damage, air-targeting, very long-ranged, ground troop with low hitpoints and moderate damage. She resembles a woman with brown eyes, short black hair and eyebrows, wearing a golden crown, a chestplate, chain mail, a team-colored robe and leggings, brown gloves, belt with a crown buckle, and boots, carries a quiver on her back, and wields a bow with a team-colored handle and arrows with team-colored fletchings. A Princess card costs 3 Elixir to deploy.
...
For 2 Cycles, if her **Evolution** is active, her cold-hearted self truly empowers her and she becomes the Ice Princess, gaining **Permafrost Point** arrows! This will make every other hit leave an ice pool on the ground for some time, chilling enemies out as a slow down effect is applied. Once defeated, she also shoots a final, weaker wave of arrows where she died, because revenge is best served cold.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 3 | 3 sec | 0.3 sec | Medium (60) | 1.2 sec | 9 | 2 | 600 | Air & Ground | x1 | Ground | Troop | Legendary |
...
#### Common: Quickdraw
> "+100% hit speed"
Princess' attack speed is increased by 100%, for a total of 1.5 seconds.
#### Rare: Royal Ranger
> "+55% range"
Princess range is increased by 55%, for a total of 13.95 tiles.
#### Epic: Pierce the Tower
> "Arrows attack"
Princess shoots three volleys per attack instead of one.
...
This card has an evolution: see [princess-evolution.md](../evolutions/princess-evolution.md). Cycles to evolve: see evolution file. Stat boosts: see evolution file.
